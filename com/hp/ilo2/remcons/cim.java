  ...
  implements MouseSyncListener
{
  ...
  private static int dvc_color; private static int dvc_last_color; private static int dvc_ib_acc = 0;
  ...
  public void serverMove(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    char c1 = (char)(paramInt3 / 256);char c2 = (char)(paramInt3 % 256);
    char c3 = (char)(paramInt4 / 256);char c4 = (char)(paramInt4 % 256);
...
/*      */
  ...
  Cursor createCursor(int paramInt)
  {
    ...
    Toolkit localToolkit = Toolkit.getDefaultToolkit();
    Image localImage;
    int[] arrayOfInt; MemoryImageSource localMemoryImageSource; switch (paramInt) {
    case 0:
